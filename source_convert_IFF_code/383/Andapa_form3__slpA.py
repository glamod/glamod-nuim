...
import pandas as pd
import csv
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_3/Andapa_Form_3/slp"
...
##extract daily tmin 
    try:
        ...
        df_slp["Observed_value"]=df_slp["Observed_value"]+900
...
##extract daily tmax taken 
    try:
        ...
        df_slp2["Observed_value"]=df_slp2["Observed_value"]+900
    ...
    try:
        ...
        df_slp3["Observed_value"]=df_slp3["Observed_value"]+900
