...
c     Extract fields from lines
      ...
      print*,'s_qckey_sourceflag=',
     +  (TRIM(s_qckey_sourceflag(i)),i=1,l_qckey)
      print*,'s_qckey_c3sflag=',
     +  (TRIM(s_qckey_c3sflag(i)),i=1,l_qckey)
      print*,'s_qckey_timescale=',
     +  (TRIM(s_qckey_timescale(i)),i=1,l_qckey)
c*****
      print*,'just leaving get_qckey'
