...
def main(station="", subset=""):
    ...
    if station != "" and subset != "":
        print("Please select either single station or list of stations run")
        return
    elif station == "" and subset == "":
        print("Please select either single station or list of stations run")
        return

    # Obtain list of station(s) to process
    if station != "":
        all_filesnames = [station]
    elif subset != "":
