...
df['Report_type_code']=''
df["Observed_value"]=df["Vent 21h"]
df['Original_observed_value']=df["Vent 21h"]
df.loc[df['Direccion21 h '] == 'Calme', 'Observed_value'] = 0
df.loc[df['Direccion21 h '] == 'Calme', 'Measurement_code_1'] = "wd1"
df.loc[df['Direccion21 h '] == 'Calme', 'Original_observed_value'] = 0
...
os.chdir("D:/African _stations_late19thC_338/338/WS/1")
df.to_csv("338-00001_wind_speed_21h.csv", index=False, sep=",")
