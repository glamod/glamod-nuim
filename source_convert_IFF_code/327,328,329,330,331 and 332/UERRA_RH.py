...
os.chdir("D:/UERRA_multiple source_sub_daily/UERRA_sub_daily/MeteoCat_UERRA_WP1_provideddata_13042017/MeteoCat_data_13042017.dir/out/tt/test")
extension = 'csv'
...
with open('output.csv') as fin:    
    ...
    os.chdir("D:/UERRA_multiple source_sub_daily/UERRA_sub_daily/MeteoCat_UERRA_WP1_provideddata_13042017/MeteoCat_data_13042017.dir/out/tt/IFF")
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_temperature_327.psv'.format(cat), "w", newline = "")
