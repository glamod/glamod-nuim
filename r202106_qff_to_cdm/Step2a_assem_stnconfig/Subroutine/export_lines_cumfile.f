...
c     27Apr2020: used for first release
      ...
      SUBROUTINE export_lines_cumfile(s_date_st,s_time_st,s_zone_st,
     +   s_pathandname_out,
...
c     Case of new file
     ...
     +   STATUS='REPLACE',ACTION='WRITE')
         ...
         WRITE(2,FMT=1002) 'New stnconfig file assembled            '
         WRITE(2,FMT=1002) '                                        '
         WRITE(2,FMT=1006) 'AJ_Kettle',s_date_st,s_time_st
         WRITE(2,FMT=1002) '                                        '
         WRITE(2,FMT=1002) 'subroutine: export_lines_cumfile.f      '
         WRITE(2,FMT=1002) '                                        '
 1002    FORMAT(a40)
