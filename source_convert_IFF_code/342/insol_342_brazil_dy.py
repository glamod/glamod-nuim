...
OUTDIR = "D:/brazil_inmet/DataDaily_M_all_years_IFF/insolation"
...
for filename in all_filenames:
    ...
    df["Elevation"] = ""
    df["Original_observed_value"] = df["INSOLACAO"]
    df["Observed_value"] = df["INSOLACAO"]
    ...
    df2.to_csv(outname+"_insolation_342.psv", index=False, sep="|")
