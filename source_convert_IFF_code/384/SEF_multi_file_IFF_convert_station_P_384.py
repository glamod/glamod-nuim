...
OUTDIR = "D:/ACRE Argentina_josvaldor/ACRE_AR/sef_data/IFF/slp"
os.chdir("D:/ACRE Argentina_josvaldor/ACRE_AR/sef_data/slp")
extension = 'tsv'
...
os.chdir("D:/ACRE Argentina_josvaldor/ACRE_AR/sef_data/IFF/slp")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_station_level_pressure_384.psv'.format(cat), "w", newline = "")
