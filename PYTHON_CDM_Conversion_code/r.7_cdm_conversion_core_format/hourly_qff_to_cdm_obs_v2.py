...
>python hourly_qff_to_cdm_obs_v2.py --station STATIONID
>python hourly_qff_to_cdm_obs_v2.py --subset FILENAME
>python hourly_qff_to_cdm_obs_v2.py --run_all
>python hourly_qff_to_cdm_obs_v2.py --help
