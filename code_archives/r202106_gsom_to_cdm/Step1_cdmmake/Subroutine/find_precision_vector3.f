...
c                NOTE 30 lines used in histogram method
      ...
      SUBROUTINE find_precision_vector3(l_rgh_lines,l_lines,
     +  s_vec_tmax,
...
c     Variables used in program
      ...
      CHARACTER(LEN=10)   :: s_lenprec_vec_right(5)
      CHARACTER(LEN=10)   :: s_lenprec_vec_left(5)

      CHARACTER(LEN=10)   :: s_lenprec_empir
      ...
      INTEGER             :: l_lines_use
c************************************************************************
c      print*,'just entered find_precision_vector2'

c      print*,'l_lines=',l_lines
c      print*,'s_vec_tmax=',(s_vec_tmax(i),i=1,l_lines)
c      DO i=1,l_lines
...
c       Case where no decimal place found
        jj=1
        DO k=i_len,1,-1
         s_charlist_dec_left(i,jj)=s_single(k:k)
         jj=jj+1
...
c      print*,'just leaving find_precision_vector2'
