...
OUTDIR = "D:/brazil_inmet/DataA_all_years_IFF/station_level_pressure/"
...
for filename in all_filenames:
    ...
    #df['Hour'] = df['HORA (UTC)']
    df["Original_observed_value"] = df["PRESSAO ATMOSFERICA AO NIVEL DA ESTACAO, HORARIA (mB)"]
    df["Observed_value"] = df["PRESSAO ATMOSFERICA AO NIVEL DA ESTACAO, HORARIA (mB)"]
    ...
    df3.to_csv(outname+"_station_level_pressure_342.psv", index=False, sep="|")
