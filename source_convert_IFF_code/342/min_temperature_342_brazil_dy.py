...
OUTDIR = "D:/brazil_inmet/DataDaily_A_all_years_IFF/minimum_temperature"
...
for filename in all_filenames:
    ...
    df["Elevation"] = ""
    df["Original_observed_value"] = df["TEMP_MIN"]
    df["Observed_value"] = df["TEMP_MIN"]
    ...
    df2.to_csv(outname+"_min_temperature_342.psv", index=False, sep="|")
