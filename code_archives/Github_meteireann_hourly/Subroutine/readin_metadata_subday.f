...
c     AJ_Kettle, Dec19/2017
      ...
      SUBROUTINE readin_metadata_subday(s_filename,l_nfile,
     +  l_meta,
...
c     Extract data from lines
      ...
      print*,'s_meta_namelist',(TRIM(s_meta_namelist(i)),i=1,l_meta)
...
c************************************************************************
      print*,'just leaving readin_metadata'
