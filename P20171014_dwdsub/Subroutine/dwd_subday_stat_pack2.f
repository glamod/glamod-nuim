...
c     AJ_Kettle, Oct26/2017
      ...
      SUBROUTINE dwd_subday_stat_pack2(l_mlent,j_sd,f_ndflag,
     +  ft_sd_pres_hpa,
...
c************************************************************************
      print*,'l_mlent,j_sd=',l_mlent,j_sd
      print*,'ft_sd_pres_hpa=',(ft_sd_pres_hpa(i),i=1,10)
      ...
      DO i=1,j_sd 
       ...
       IF (.NOT.(ft_sd_pres_hpa(i).NE.f_ndflag)) THEN
        ...
        print*,'index flagged data=',i,j_sd
       ENDIF     
      ENDDO
