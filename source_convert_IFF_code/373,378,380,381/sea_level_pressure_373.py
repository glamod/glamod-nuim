...
OUTDIR = "D:/Ed_Hawkins_data/ehawkins/BEN-NEVIS-FORT-WILLIAM/IFF/mslp"
os.chdir("D:/Ed_Hawkins_data/ehawkins/BEN-NEVIS-FORT-WILLIAM/sef_data/mslp")
extension = 'tsv'
...
os.chdir("D:/Ed_Hawkins_data/ehawkins/BEN-NEVIS-FORT-WILLIAM/IFF/mslp")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_sea_level_pressure_373.psv'.format(cat), "w", newline = "")
