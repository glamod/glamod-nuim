...
import pandas as pd
import csv
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/ANDAPA_Form_2/ANDAPA_Form_2/wetB"
...
##extract daily tmin 
    try:
        ...
        df_wbt["Observed_value"]=df_wbt["Observed_value"]/10
...
##extract daily tmax taken 
    try:
        ...
        df_wbt2["Observed_value"]=df_wbt2["Observed_value"]/10
    ...
    try:
        ...
        df_wbt3["Observed_value"]=df_wbt3["Observed_value"]/10
        ...
        merged_wbt['Timestamp'] = merged_wbt['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
