...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Labrador data/data_canada/IFF/station_level_pressure")
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_station_level_pressure_349.psv"
    print(outfilename)
