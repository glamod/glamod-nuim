...
>python hourly_qff_to_cdm_lite_v1_pressure_extract.py --station STATIONID
>python hourly_qff_to_cdm_lite_v2_pressure_extract.py --subset FILENAME
>python hourly_qff_to_cdm_lite_v2_pressure_extract.py --run_all
>python hourly_qff_to_cdm_lite_v2_pressure_extract.py --help
...
def main(station="", subset="", run_all=False, clobber=False):
    ...
    for filename in all_filenames:
        ...
        try:
            ...
            #extract slp and mslp for 20cr Ed Hawkins
            # Filter the DataFrame to keep rows where 'observed_variable' is either "57" or "58"
            filtered_df = merged_df[merged_df['observed_variable'].isin(["57", "58"])]
            ...
            for station_id, group_df in filtered_df.groupby('primary_station_id'):
                ...
                file_path = f"C:/Users/snoone/Dropbox/Copernicus_2021/admin/7th_data_release/code/hourly/pressure/{station_id}_pressure_data.psv"
