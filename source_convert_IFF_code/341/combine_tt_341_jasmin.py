...
os.chdir("/work/scratch-pw/snoone/2011_21/tt")
extension = 'csv'
...
os.chdir(r"/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/temperature/341_g")
cats = sorted(df_final['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_temperature_341.psv"
    print(outfilename)
