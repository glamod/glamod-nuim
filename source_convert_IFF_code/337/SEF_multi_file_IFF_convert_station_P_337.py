...
OUTDIR = "D:/ISPD3043_mccoll_new/ISPD3043/ISPD3043/sef_data/out"
os.chdir("D:/ISPD3043_mccoll_new/ISPD3043/ISPD3043/sef_data/")
extension = 'tsv'
...
os.chdir("D:/ISPD3043_mccoll_new/ISPD3043/ISPD3043/sef_data/out")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_station_level_pressure_336.psv'.format(cat), "w", newline = "")
