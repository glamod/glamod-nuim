...
c     AJ_Kettle, Oct17/2017
      ...
      SUBROUTINE get_data_1file(s_directory,s_filename,
     +  l_mlen0,f_ndflag,
...
c************************************************************************
      ...
      CHARACTER(LEN=300)  :: s_linsto(l_mlen0)
      INTEGER             :: i_modulo
      ...
      CHARACTER(LEN=2)    :: s_kennung(l_mlen0)
      CHARACTER(LEN=5)    :: s_stnnumber(l_mlen0)
      CHARACTER(LEN=4)    :: s_year(l_mlen0)
      CHARACTER(LEN=2)    :: s_month(l_mlen0)
      CHARACTER(LEN=2)    :: s_day(l_mlen0)
      CHARACTER(LEN=5)    :: s_pres1(l_mlen0)
      CHARACTER(LEN=5)    :: s_pres2(l_mlen0)
      CHARACTER(LEN=5)    :: s_pres3(l_mlen0)
      CHARACTER(LEN=1)    :: s_pres1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_pres2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_pres3_qc(l_mlen0)
      CHARACTER(LEN=5)    :: s_pres_dayavg(l_mlen0)
      CHARACTER(LEN=4)    :: s_airt_daymax(l_mlen0)
      CHARACTER(LEN=4)    :: s_airt_daymin(l_mlen0)
      CHARACTER(LEN=3)    :: s_airt_range(l_mlen0)
      CHARACTER(LEN=4)    :: s_boden_daymin(l_mlen0)
      CHARACTER(LEN=4)    :: s_airt1(l_mlen0)
      CHARACTER(LEN=4)    :: s_airt2(l_mlen0)
      CHARACTER(LEN=4)    :: s_airt3(l_mlen0)
      CHARACTER(LEN=1)    :: s_airt1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_airt2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_airt3_qc(l_mlen0)
      CHARACTER(LEN=4)    :: s_airt_dayavg(l_mlen0)
      CHARACTER(LEN=4)    :: s_wetb1(l_mlen0)
      CHARACTER(LEN=4)    :: s_wetb2(l_mlen0)
      CHARACTER(LEN=4)    :: s_wetb3(l_mlen0)
      CHARACTER(LEN=1)    :: s_wetb1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_wetb2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_wetb3_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_wetb1_ice(l_mlen0)
      CHARACTER(LEN=1)    :: s_wetb2_ice(l_mlen0)
      CHARACTER(LEN=1)    :: s_wetb3_ice(l_mlen0)
      CHARACTER(LEN=4)    :: s_vprs1(l_mlen0)
      CHARACTER(LEN=4)    :: s_vprs2(l_mlen0)
      CHARACTER(LEN=4)    :: s_vprs3(l_mlen0)
      CHARACTER(LEN=1)    :: s_vprs1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_vprs2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_vprs3_qc(l_mlen0)
      CHARACTER(LEN=4)    :: s_vprs_dayavg(l_mlen0)
      CHARACTER(LEN=3)    :: s_relh1(l_mlen0)
      CHARACTER(LEN=3)    :: s_relh2(l_mlen0)
      CHARACTER(LEN=3)    :: s_relh3(l_mlen0)
      CHARACTER(LEN=1)    :: s_relh1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_relh2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_relh3_qc(l_mlen0)
      CHARACTER(LEN=3)    :: s_relh_dayavg(l_mlen0)
      CHARACTER(LEN=3)    :: s_relhreg1(l_mlen0)
      CHARACTER(LEN=3)    :: s_relhreg2(l_mlen0)
      CHARACTER(LEN=3)    :: s_relhreg3(l_mlen0)
      CHARACTER(LEN=1)    :: s_relhreg1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_relhreg2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_relhreg3_qc(l_mlen0)
      CHARACTER(LEN=2)    :: s_wdir1(l_mlen0)
      CHARACTER(LEN=2)    :: s_wspd1(l_mlen0)
      CHARACTER(LEN=2)    :: s_wdir2(l_mlen0)
      CHARACTER(LEN=2)    :: s_wspd2(l_mlen0)
      CHARACTER(LEN=2)    :: s_wdir3(l_mlen0)
      CHARACTER(LEN=2)    :: s_wspd3(l_mlen0)
      CHARACTER(LEN=1)    :: s_wspdwdir1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_wspdwdir2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_wspdwdir3_qc(l_mlen0)
      CHARACTER(LEN=3)    :: s_wspd_dayavg(l_mlen0)
      CHARACTER(LEN=2)    :: s_ccov1(l_mlen0)
      CHARACTER(LEN=2)    :: s_ccov2(l_mlen0)
      CHARACTER(LEN=2)    :: s_ccov3(l_mlen0)
      CHARACTER(LEN=1)    :: s_ccov1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_ccov2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_ccov3_qc(l_mlen0)
      CHARACTER(LEN=3)    :: s_ccov_dayavg(l_mlen0)
      CHARACTER(LEN=3)    :: s_sundur_daytot(l_mlen0)
      CHARACTER(LEN=2)    :: s_visi1(l_mlen0)
      CHARACTER(LEN=2)    :: s_visi2(l_mlen0)
      CHARACTER(LEN=2)    :: s_visi3(l_mlen0)
      CHARACTER(LEN=1)    :: s_visi1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_visi2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_visi3_qc(l_mlen0)
      CHARACTER(LEN=2)    :: s_grdcnd1(l_mlen0)
      CHARACTER(LEN=2)    :: s_grdcnd2(l_mlen0)
      CHARACTER(LEN=2)    :: s_grdcnd3(l_mlen0)
      CHARACTER(LEN=1)    :: s_grdcnd1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_grdcnd2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_grdcnd3_qc(l_mlen0)
      CHARACTER(LEN=4)    :: s_ppt1(l_mlen0)
      CHARACTER(LEN=4)    :: s_ppt2(l_mlen0)
      CHARACTER(LEN=4)    :: s_ppt3(l_mlen0)
      CHARACTER(LEN=1)    :: s_ppt1_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_ppt2_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_ppt3_qc(l_mlen0)
      CHARACTER(LEN=4)    :: s_ppt_daytot(l_mlen0)
      CHARACTER(LEN=3)    :: s_snowcover(l_mlen0)
      CHARACTER(LEN=3)    :: s_snow_daytot(l_mlen0)
      CHARACTER(LEN=3)    :: s_wspd_daymax(l_mlen0)
      CHARACTER(LEN=4)    :: s_snowmelted(l_mlen0)
      CHARACTER(LEN=5)    :: s_we_snowmelted(l_mlen0)
      CHARACTER(LEN=5)    :: s_we_snowcover(l_mlen0)

      CHARACTER(LEN=4)    :: s_year1(l_mlen0)
      CHARACTER(LEN=4)    :: s_year2(l_mlen0)
      CHARACTER(LEN=4)    :: s_year3(l_mlen0)
      CHARACTER(LEN=2)    :: s_month1(l_mlen0)
      CHARACTER(LEN=2)    :: s_month2(l_mlen0)
      CHARACTER(LEN=2)    :: s_month3(l_mlen0)
      CHARACTER(LEN=2)    :: s_day1(l_mlen0)
      CHARACTER(LEN=2)    :: s_day2(l_mlen0)
      CHARACTER(LEN=2)    :: s_day3(l_mlen0)
      CHARACTER(LEN=4)    :: s_time1(l_mlen0)
      CHARACTER(LEN=4)    :: s_time2(l_mlen0)
      CHARACTER(LEN=4)    :: s_time3(l_mlen0)
      CHARACTER(LEN=3)    :: s_time_id1(l_mlen0)
      CHARACTER(LEN=3)    :: s_time_id2(l_mlen0)
      CHARACTER(LEN=3)    :: s_time_id3(l_mlen0)

      CHARACTER(LEN=4)    :: s_timeday(l_mlen0)
      CHARACTER(LEN=3)    :: s_timeday_id(l_mlen0)

      INTEGER             :: ii_kl,ii_kx,ii_kk,ii_kf,ii_kg

c     Variables to string data
      INTEGER             :: l_line3
      CHARACTER(LEN=4)    :: s_sd_year(l_mlen0)
      CHARACTER(LEN=2)    :: s_sd_month(l_mlen0) 
      CHARACTER(LEN=2)    :: s_sd_day(l_mlen0) 
      CHARACTER(LEN=4)    :: s_sd_time(l_mlen0)
      CHARACTER(LEN=3)    :: s_sd_time_id(l_mlen0)
      CHARACTER(LEN=5)    :: s_sd_pres(l_mlen0)
      CHARACTER(LEN=4)    :: s_sd_airt(l_mlen0)
      CHARACTER(LEN=4)    :: s_sd_wetb(l_mlen0)
      CHARACTER(LEN=4)    :: s_sd_vprs(l_mlen0)
      CHARACTER(LEN=3)    :: s_sd_relh(l_mlen0)
      CHARACTER(LEN=3)    :: s_sd_relhreg(l_mlen0)
      CHARACTER(LEN=2)    :: s_sd_wdir(l_mlen0)
      CHARACTER(LEN=2)    :: s_sd_wspd(l_mlen0)
      CHARACTER(LEN=2)    :: s_sd_ccov(l_mlen0)
      CHARACTER(LEN=2)    :: s_sd_visi(l_mlen0)
      CHARACTER(LEN=2)    :: s_sd_grdcnd(l_mlen0)
      CHARACTER(LEN=4)    :: s_sd_ppt(l_mlen0)

      CHARACTER(LEN=1)    :: s_sd_pres_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_airt_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_wetb_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_vprs_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_relh_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_relhreg_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_wspdwdir_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_ccov_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_visi_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_grdcnd_qc(l_mlen0)
      CHARACTER(LEN=1)    :: s_sd_ppt_qc(l_mlen0)

      CHARACTER(LEN=1)    :: s_sd_wetb_ice(l_mlen0)
...
c     Subdaily string
      REAL                :: f_sd_pres_hpa(l_mlen0)
      REAL                :: f_sd_airt_c(l_mlen0)
      REAL                :: f_sd_wetb_c(l_mlen0)
      REAL                :: f_sd_vprs_hpa(l_mlen0)
      REAL                :: f_sd_relh_pc(l_mlen0)
      REAL                :: f_sd_relhreg_pc(l_mlen0)
      REAL                :: f_sd_wdir_code(l_mlen0)
      REAL                :: f_sd_wspd_bft(l_mlen0)
      REAL                :: f_sd_ccov_okta(l_mlen0)
      REAL                :: f_sd_visi_code(l_mlen0)
      REAL                :: f_sd_grdcnd_code(l_mlen0)
      REAL                :: f_sd_ppt_mm(l_mlen0)

c     Daily string
      REAL                :: f_pres_dayavg_hpa(l_mlen0)
      REAL                :: f_airt_daymax_c(l_mlen0)
      REAL                :: f_airt_daymin_c(l_mlen0)
      REAL                :: f_airt_range_c(l_mlen0)
      REAL                :: f_boden_daymin_c(l_mlen0)
      REAL                :: f_airt_dayavg_c(l_mlen0)
      REAL                :: f_vprs_dayavg_hpa(l_mlen0)
      REAL                :: f_relh_dayavg_pc(l_mlen0)
      REAL                :: f_wspd_dayavg_bft(l_mlen0)
      REAL                :: f_ccov_dayavg_okta(l_mlen0)
      REAL                :: f_sundur_daytot_h(l_mlen0)
      REAL                :: f_ppt_daytot_mm(l_mlen0)
      REAL                :: f_snowcover_cm(l_mlen0)
      REAL                :: f_snow_daytot_cm(l_mlen0)
      REAL                :: f_wspd_daymax_ms(l_mlen0)
      REAL                :: f_snowmelted_cm(l_mlen0)
      REAL                :: f_we_snowmelted_mm(l_mlen0)
      REAL                :: f_we_snowcover_mm(l_mlen0)
c************************************************************************
      print*,'just inside get_data_1file'
c************************************************************************
      s_ndflag_m9999='-9999'
      s_ndflag_m999 ='-999'
      s_ndflag_m99  ='-99'
...
c        CALL SLEEP(1) 
        ...
        i_modulo=MODULO(ii,2)

        IF (i_modulo.EQ.1) THEN 
...
c         CALL SLEEP(1)
         ...
         IF (jj.GE.l_mlen0) THEN 
          print*,'emergency stop get_data_1file, jj>l_mlen0'
          CALL SLEEP(4)
         ENDIF
...
c      print*,'l_line=',l_line,i_maxlen1,l_mlen0
...
c      print*,'just before year convert'
...
c      print*,'just after year convert'
c************************************************************************
c     Test kl/kx/kk/kf/kg
      ii_kl=0
      ii_kx=0
      ii_kk=0
      ii_kf=0
...
c        s_time3(i)   ='2130'
        ...
        GOTO 20
       ENDIF
       IF (TRIM(s_kennung(i)).EQ.'KX') THEN 
        s_year1(i)   =s_year(i)
        s_year2(i)   =s_year(i)
        s_year3(i)   =s_year(i)
        s_month1(i)  =s_month(i)
        ...
        GOTO 20
       ENDIF
       IF (TRIM(s_kennung(i)).EQ.'KK') THEN 
...
c        s_time3(i)   ='2130'
        ...
        GOTO 20
       ENDIF
       IF (TRIM(s_kennung(i)).EQ.'KF') THEN 
...
c        s_time3(i)   ='2100'
        ...
        GOTO 20
       ENDIF
       IF (TRIM(s_kennung(i)).EQ.'KG') THEN 
        s_year1(i)   =s_year(i)
        s_year2(i)   =s_year(i)
        s_year3(i)   =s_year(i)
        s_month1(i)  =s_month(i)
       ...
       print*,'emergency stop get_data_1file',i,s_kennung(i)
       CALL SLEEP(100)
...
c        print*,'i,s_sd_pres=',i,s_sd_pres(i)
        READ(s_test,*) f_test
...
c      PRES_DAYAVG ndflag=-9999
       ...
       IF (s_test.NE.s_ndflag_m9999) THEN
c       print*,'i,s_pres_dayavg=',i,s_pres_dayavg(i)
        READ(s_test,*) f_test
        f_pres_dayavg_hpa(i)   =f_test/10.0       !convert to hpa

c        IF (f_pres_dayavg_hpa(i).LT.0.0) THEN 
c         print*,'emergency stop, get_data_1file, dayavg_pres'
