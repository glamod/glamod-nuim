...
VARIABLE_NAMES = ["SNWD", "PRCP", "TMIN", "TMAX", "TAVG", "SNOW", "AWND", "AWDR", "WESD","ASLP","ASTP"]
...
def add_data_policy(var_frame, policy_frame):
    ...
    var_frame['height_of_station_above_sea_level'] = var_frame['height_of_station_above_sea_level'].astype(str).apply(lambda x: x.replace('.0',''))
