...
os.chdir("D:/UERRA_multiple source_sub_daily/UERRA_sub_daily/MeteoCat_UERRA_WP1_provideddata_13042017/MeteoCat_data_13042017.dir/out/wd")
extension = 'csv'
...
df['Day']=df["day"]
df['Hour']=df["hour"]
df['Observed_value']=df["qcvalue"]
df['Original_observed_value']=df["convertedvalue"]
...
with open('output.csv') as fin:    
    ...
    os.chdir("D:/UERRA_multiple source_sub_daily/UERRA_sub_daily/MeteoCat_UERRA_WP1_provideddata_13042017/MeteoCat_data_13042017.dir/out/wd/IFF")
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_station_level_pressure_327.psv'.format(cat), "w", newline = "")
