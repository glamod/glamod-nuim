# -*- coding: utf-8 -*-
"""
Created on Tue Oct  7 10:00:14 2025
...
#    # --- NEW: delete temp folders after merge ---
...
if __name__ == "__main__":
    ...
    parser.add_argument("--job_id", default="job_xx")  # can be "main" or 0,1,2...
    ...
    if args.merge_only:
        ...
        if args.job_id not in ["main", "job_xx"]:
            ...
            stations_for_this_job = all_stations  # run all if main job
