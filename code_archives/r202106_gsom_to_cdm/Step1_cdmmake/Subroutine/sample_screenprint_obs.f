c     Subroutine to do screen print of observations
c     AJ_Kettle, 16Dec2020
c     03Feb2021: char width changed to slave designation
...
c     NOTE: new column at 46 for 01May2020 release
      CHARACTER(LEN=*)   :: s_obs_observation_id                  !1
      CHARACTER(LEN=*)   :: s_obs_report_id                       !2
      CHARACTER(LEN=*)   :: s_obs_data_policy_licence             !3
      CHARACTER(LEN=*)   :: s_obs_date_time                       !4
      CHARACTER(LEN=*)   :: s_obs_date_time_meaning               !5
      CHARACTER(LEN=*)   :: s_obs_observation_duration            !6
      CHARACTER(LEN=*)   :: s_obs_longitude                       !7
      CHARACTER(LEN=*)   :: s_obs_latitude                        !8
      CHARACTER(LEN=*)   :: s_obs_crs                             !9
      CHARACTER(LEN=*)   :: s_obs_z_coordinate                    !10
      CHARACTER(LEN=*)   :: s_obs_z_coordinate_type               !11
      CHARACTER(LEN=*):: s_obs_observation_height_above_station_surface !12 
      CHARACTER(LEN=*)   :: s_obs_observed_variable               !13
      CHARACTER(LEN=*)   :: s_obs_secondary_variable              !14
      CHARACTER(LEN=*)   :: s_obs_observation_value               !15
      CHARACTER(LEN=*)   :: s_obs_value_significance              !16
      CHARACTER(LEN=*)   :: s_obs_secondary_value                 !17
      CHARACTER(LEN=*)   :: s_obs_units                           !18
      CHARACTER(LEN=*)   :: s_obs_code_table                      !19
      CHARACTER(LEN=*)   :: s_obs_conversion_flag                 !20
      CHARACTER(LEN=*)   :: s_obs_location_method                 !21
      CHARACTER(LEN=*)   :: s_obs_location_precision              !22
      CHARACTER(LEN=*)   :: s_obs_coordinate_method               !23
      CHARACTER(LEN=*)   :: s_obs_bbox_min_longitude              !24
      CHARACTER(LEN=*)   :: s_obs_bbox_max_longitude              !25
      CHARACTER(LEN=*)   :: s_obs_bbox_min_latitude               !26
      CHARACTER(LEN=*)   :: s_obs_bbox_max_latitude               !27
      CHARACTER(LEN=*)   :: s_obs_spatial_representativeness      !28
      CHARACTER(LEN=*)   :: s_obs_quality_flag                    !29
      CHARACTER(LEN=*)   :: s_obs_numerical_precision             !30
      CHARACTER(LEN=*)   :: s_obs_sensor_id                       !31
      CHARACTER(LEN=*)   :: s_obs_sensor_automation_status        !32
      CHARACTER(LEN=*)   :: s_obs_exposure_of_sensor              !33
      CHARACTER(LEN=*)   :: s_obs_original_precision              !34
      CHARACTER(LEN=*)   :: s_obs_original_units                  !35
      CHARACTER(LEN=*)   :: s_obs_original_code_table             !36
      CHARACTER(LEN=*)   :: s_obs_original_value                  !37
      CHARACTER(LEN=*)   :: s_obs_conversion_method               !38
      CHARACTER(LEN=*)   :: s_obs_processing_code                 !39
      CHARACTER(LEN=*)   :: s_obs_processing_level                !40
      CHARACTER(LEN=*)   :: s_obs_adjustment_id                   !41
      CHARACTER(LEN=*)   :: s_obs_traceability                    !42
      CHARACTER(LEN=*)   :: s_obs_advanced_qc                     !43
      CHARACTER(LEN=*)   :: s_obs_advanced_uncertainty            !44
      CHARACTER(LEN=*)   :: s_obs_advanced_homogenisation         !45
      CHARACTER(LEN=*)   :: s_obs_advanced_assimilation_feedback  !46  new for 01May release
      CHARACTER(LEN=*)   :: s_obs_source_id                       !47  from stnconfig file
...
c        IF (f_vec_original_value(j).NE.f_ndflag) THEN 
     ...
     +     TRIM(s_obs_source_id)//'='
         ...
         STOP 'header_obs_lite_table2; observation list'
