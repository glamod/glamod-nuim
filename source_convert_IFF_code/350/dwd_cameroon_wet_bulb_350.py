...
import csv
#import numpy as np     
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/data_cameroon/") 
...
for currentFile in files:
    with open(currentFile, "r") as theFirstFile:
        for line in theFirstFile:
            ...
            field8 = "NULL"
            field9 = line[57:61]
            field10 = line[104:108]
            field11 = line[109:110]
            field12 = line[104:108]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "350"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/IFF/wet_bulb_temperature/") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_wet_bulb_temperature_350.psv"
    print(outfilename)
