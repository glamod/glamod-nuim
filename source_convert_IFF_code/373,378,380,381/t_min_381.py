...
OUTDIR = "D:/Ed_Hawkins_data/ehawkins/UK-DWRs/IFF/tmin"
os.chdir("D:/Ed_Hawkins_data/ehawkins/UK-DWRs/sef_data/tmin")
extension = 'tsv'
...
os.chdir("D:/Ed_Hawkins_data/ehawkins/UK-DWRs/IFF/tmin")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_temperature_minimum_381.psv'.format(cat), "w", newline = "")
