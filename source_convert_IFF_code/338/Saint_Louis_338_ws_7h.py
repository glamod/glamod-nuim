...
df['Report_type_code']=''
df["Observed_value"]=df["21h.5"]
df['Original_observed_value']=df["21h.5"]
...
os.chdir("D:/African _stations_late19thC_338/338/ws/4")
df.to_csv("338-00004_ws_21h.csv", index=False, sep=",")
