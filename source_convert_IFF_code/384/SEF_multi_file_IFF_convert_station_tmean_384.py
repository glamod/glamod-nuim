...
OUTDIR = "D:/ACRE Argentina_josvaldor/ACRE_AR/sef_data/IFF/wd"
os.chdir("D:/ACRE Argentina_josvaldor/ACRE_AR/sef_data/wd")
extension = 'tsv'
...
for filename in all_filenames:
    ...
    df['Original_observed_value_units']="CD"
...
os.chdir("D:/ACRE Argentina_josvaldor/ACRE_AR/sef_data/IFF/wd")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_wind_direction_384.psv'.format(cat), "w", newline = "")
