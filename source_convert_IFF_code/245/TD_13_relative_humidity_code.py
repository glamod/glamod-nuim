...
df = pd.read_csv("Test2.txt", usecols = ['Year', 'Month',"Day",
...
with open('output2.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_relative_humidity_245.psv'.format(cat), "w", newline = "")
