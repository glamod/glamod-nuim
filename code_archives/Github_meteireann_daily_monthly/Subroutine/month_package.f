...
c     AJ_Kettle, Jan9/2018
      ...
      SUBROUTINE month_package(f_ndflag,
...
c     internal variables
      ...
      INTEGER             :: l_mon_airt_k
      CHARACTER(LEN=2)    :: s_monrec_airt_k_year(l_mlent_mon)
      CHARACTER(LEN=4)    :: s_monrec_airt_k_month(l_mlent_mon)
      REAL                :: f_monrec_airt_k_nseconds(l_mlent_mon)
      CHARACTER(LEN=8)    :: s_monrec_airt_k_stime(l_mlent_mon)
      CHARACTER(LEN=5)    :: s_monrec_airt_k_timezone5(l_mlent_mon)
      REAL                :: f_monrec_avg_airt_k(l_mlent_mon)
      INTEGER             :: i_monrec_airt_k_flag(l_mlent_mon)
c************************************************************************
...
c************************************************************************
c     Create avg month airt values       
...
c      Celsius units
     ...
     +     f_monrec_avg_mindy_c(i).NE.f_ndflag) THEN 
        f_monrec_avg_airt_c(ii1)=
     +     0.5*(f_monrec_avg_maxdy_c(i)+f_monrec_avg_mindy_c(i))
        ii1=ii1+1
       ENDIF
       IF (.NOT.(f_monrec_avg_maxdy_c(i).NE.f_ndflag.AND.
     +           f_monrec_avg_mindy_c(i).NE.f_ndflag)) THEN 
        f_monrec_avg_airt_c(ii1)=
     +     0.5*(f_monrec_avg_maxdy_c(i)+f_monrec_avg_mindy_c(i))
        ii1b=ii1b+1
...
c      Kelvin units
     ...
     +     f_monrec_avg_mindy_k(i).NE.f_ndflag) THEN 
        f_monrec_avg_airt_k(ii1)=
     +     0.5*(f_monrec_avg_maxdy_k(i)+f_monrec_avg_mindy_k(i))
        ii2=ii2+1
       ENDIF
       IF (.NOT.(f_monrec_avg_maxdy_k(i).NE.f_ndflag.AND.
     +           f_monrec_avg_mindy_k(i).NE.f_ndflag)) THEN 
        f_monrec_avg_airt_k(ii1)=
     +     0.5*(f_monrec_avg_maxdy_k(i)+f_monrec_avg_mindy_k(i))
        ii2b=ii2b+1
      ...
      print*,'ii1,ii1b',ii1,ii1b
      print*,'ii2,ii2b',ii2,ii2b
c************************************************************************
