...
with open('output2.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_dew_point_temperature_245.psv'.format(cat), "w", newline = "")
