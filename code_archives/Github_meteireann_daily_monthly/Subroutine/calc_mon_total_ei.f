...
c     AJ_Kettle, Nov09/2017
      ...
      SUBROUTINE calc_mon_total_ei(l_mlent,l_mlent_mon,l_datalines,
     +   s_vec_date,f_vec_airt_k,
     +   l_mon,
     +   s_monrec_year,s_monrec_month,
     +   f_monrec_common_nseconds,
     +   s_monrec_common_stime,s_monrec_common_timezone5,
     +   f_monrec_value,f_monrec_total,i_monrec_flag)
...
c************************************************************************
      print*,'just inside calc_mon_total_ei'
...
c      Increment counter only in good data situation
       IF (f_vec_airt_k(i).NE.-999.0) THEN 
