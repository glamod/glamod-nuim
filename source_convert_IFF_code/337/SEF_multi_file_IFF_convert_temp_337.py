...
OUTDIR = "D:/CCSP_China_India_CMcoll/sef/temperature/out"
os.chdir("D:/CCSP_China_India_CMcoll/sef/temperature")
extension = 'tsv'
...
for filename in all_filenames:
    ...
    df["Observed_value2"]=df["Observed_value"]-273.15
    ...
    #with open(filename, "w") as outfile:a
...
os.chdir("D:/CCSP_China_India_CMcoll/sef/temperature/out")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_temperatue_337.psv'.format(cat), "w", newline = "")
