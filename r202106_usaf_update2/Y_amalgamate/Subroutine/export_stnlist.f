...
c     AJ_Kettle, 22Apr2021
      ...
      SUBROUTINE export_stnlist(s_date_st,s_time_st,
...
c     Variables used within subroutine
      ...
      INTEGER             :: i_len_max
c************************************************************************
      print*,'just inside export_stnlist'
...
c*****
     ...
     +  FORM='formatted',STATUS='REPLACE',ACTION='WRITE')   
      ...
      WRITE(2,1000) '                                       '
      WRITE(2,1000) 'subdirectory: export_stnlist.f         '
      WRITE(2,1000) '                                       '
...
c      INTEGER             :: i_mat_stnlist_flag(l_rgh_stn,3)
      ...
      WRITE(2,1004) 'Station Netplat ','2019','2020','2021'
      WRITE(2,1004) '+--------------+','+--+','+--+','+--+'
 ...
 1006 FORMAT(t1,a16,t18,i4,t23,i4,t28,i4)
     ...
     +  i_mat_stnlist_flag(i,3)
      ...
      print*,'just leaving export_stnlist'
