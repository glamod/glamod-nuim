...
import pandas as pd
import csv
OUTDIR7 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/relative_humidity"
OUTDIR6 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/cloud_cover"
OUTDIR5 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/relative_humidity"
OUTDIR4 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/wet_bulb"
OUTDIR3 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/dry_bulb"
OUTDIR2 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/dy_temperature/mean"
OUTDIR1 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/dy_temperature/max"
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2/out/dy_temperature/min"
os.chdir("C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/students_GY201_examples_sheets/code_extract/andapa/form2")
extension = 'xlsx'
...
##extract daily tmin 
    try:
        ...
        df_tmin = df_tmin[["Source_ID",'Station_ID',"Station_name","Alias_station_name",  
                                ...
                                "Measurement_code_2"]]
        df_tmin=df_tmin.dropna(subset = ['Observed_value'])
...
##change time zones
        ...
        df_tmin['Timestamp'] = df_tmin['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
...
##save output file   
        year=df_tmin.iloc[1]["Year"]
        month=df_tmin.iloc[1]["Month"]
        date=(year+"_"+month)
        source_id=df_tmin.iloc[1]["Source_ID"]
...
##extract daily tmax taken 
    try:
        ...
        df_tmax = df_tmax[["Source_ID",'Station_ID',"Station_name","Alias_station_name",  
                                ...
                                "Report_type_code","Measurement_code_1",
                                "Measurement_code_2"]]
        df_tmax=df_tmax.dropna(subset = ['Observed_value'])
    ...
    #change time zones
        ...
        df_tmax['Timestamp'] = df_tmax['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
...
##save output file   
        year=df_tmax.iloc[1]["Year"]
        month=df_tmax.iloc[1]["Month"]
        date=(year+"_"+month)
        source_id=df_tmax.iloc[1]["Source_ID"]
    ...
    try:
        ...
        df_tmean = df_tmean[["Source_ID",'Station_ID',"Station_name","Alias_station_name",  
                                ...
                                "Report_type_code","Measurement_code_1",
                                "Measurement_code_2"]]
        df_tmean=df_tmean.dropna(subset = ['Observed_value'])
    ...
    #change time zones
        ...
        df_tmean['Timestamp'] = df_tmean['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
...
##save output file   
        year=df_tmean.iloc[1]["Year"]
        month=df_tmean.iloc[1]["Month"]
        date=(year+"_"+month)
        source_id=df_tmean.iloc[1]["Source_ID"]
