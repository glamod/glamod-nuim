...
OUTDIR = "D:/Ed_Hawkins_data/ehawkins/UK-DWRs/IFF/tb"
os.chdir("D:/Ed_Hawkins_data/ehawkins/UK-DWRs/sef_data/tb")
extension = 'tsv'
...
os.chdir("D:/Ed_Hawkins_data/ehawkins/UK-DWRs/IFF/tb")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_wet_bulb_temperature__381.psv'.format(cat), "w", newline = "")
