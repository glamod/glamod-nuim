...
OUTDIR = "D:/brazil_inmet/DataDaily_A_all_years_IFF/precipitation"
...
for filename in all_filenames:
    ...
    df["Elevation"] = ""
    df["Original_observed_value"] = df["CHUVA"]
    df["Observed_value"] = df["CHUVA"]
    ...
    df2.to_csv(outname+"_precipitation_342.psv", index=False, sep="|")
