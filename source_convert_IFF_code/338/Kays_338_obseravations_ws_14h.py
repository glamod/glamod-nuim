...
df['Report_type_code']=''
df["Observed_value"]=df["Vent 14h"]
df['Original_observed_value']=df["Vent 14h"]
df.loc[df['Direccion 14h '] == 'Calme', 'Observed_value'] = 0
df.loc[df['Direccion 14h '] == 'Calme', 'Measurement_code_1'] = "wd1"
...
df.to_csv("338-00001_wind_speed_14h.csv", index=False, sep=",")
