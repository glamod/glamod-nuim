...
OUTDIR = "D:/Palatina/sef_data/monthly/t-midrange/IFF"
os.chdir("D:/Palatina/sef_data/monthly/t-midrange")
extension = 'tsv'
...
for filename in all_filenames:
    ...
    df['Measurement_code_2']='Null'
    df['Measurement_code_1']="Null"
...
os.chdir("D:/Palatina/sef_data/monthly/t-midrange/IFF")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_midrange__temperature_357.psv'.format(cat), "w", newline = "")
