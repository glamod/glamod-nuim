...
import pandas as pd
import csv
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Macenta_Form_2/dryB"
...
##extract daily tmax taken 
    ...
    try:
        ...
        merged_dyb['Timestamp'] = merged_dyb['Timestamp'].dt.tz_localize('Etc/GMT-0').dt.tz_convert('GMT')
