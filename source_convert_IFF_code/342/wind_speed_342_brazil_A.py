...
OUTDIR = "D:/brazil_inmet/DataA_all_years_IFF/wind_speed/"
...
for filename in all_filenames:
    ...
    df['Minute'] = "0"
    df["Source_QC_flag"]=""
    df["Original_observed_value_units"] = "m/s"
    df['Report_type_code'] = ""
    ...
    #df['Hour'] = df['HORA (UTC)']
    df["Original_observed_value"] = df["VENTO, VELOCIDADE HORARIA (m/s)"]
    df["Observed_value"] = df["VENTO, VELOCIDADE HORARIA (m/s)"]
    ...
    df3.to_csv(outname+"_wind_speed_342.psv", index=False, sep="|")
