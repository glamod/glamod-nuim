...
import os
#import numpy as np     
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Labrador data/data_canada/") 
...
###needd to calculate decimals offline and input here
            ...
            field8 = "NULL"
            field9 = line[48:51]
            field10 = line[113:116]
            field11 = line[116:118]
            field12 = line[113:116]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "349"
            field16 = "NULL"
...
#giantDataFrame['Observed_value'] = giantDataFrame['Observed_value']*100
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Labrador data/")
...
giantDataFrame['Timestamp'] = giantDataFrame['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Labrador data/data_canada/IFF/relative_humidity")
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_relative_humidity_349.psv"
    print(outfilename)
