...
c     Feb14/2018: modified to create 50-column file

      SUBROUTINE export_observation_subday3(f_ndflag,s_directory_root,
     +  l_datalines,
...
c         Declare source_id: DWD=82, Met Eireann=158
          s_source_id='158'
c*******
