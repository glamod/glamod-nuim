...
df=pd.read_excel("Mayumba1908.xlsx",skiprows = 1,sheet_name="data") 
#df2=pd.read_excel("1953.xlsx",sheet_name="j9") 
df["Source_ID"]="338"
df["Station_ID"]="338-00002"
...
df['Report_type_code']=''
df["Observed_value"]=df["6h 30.2"]
df['Original_observed_value']=df["6h 30.2"]
#df.loc[df['15h.4'] == 'Calme', 'Observed_value'] = 0
#df.loc[df['15h.4'] == 'Calme', 'Measurement_code_1'] = "wd1"
#df.loc[df['15h.4'] == 'Calme', 'Original_observed_value'] = 0
...
os.chdir("D:/African _stations_late19thC_338/338/temperature/2")
df.to_csv("338-00002_temperature_6.30.csv", index=False, sep=",")
