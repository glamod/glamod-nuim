...
OUTDIR = "D:/brazil_inmet/DataA_all_years_IFF/precipitation/"
...
for filename in all_filenames:
    ...
    #df['Hour'] = df['HORA (UTC)']
    df["Original_observed_value"] = df["PRECIPITAÇÃO TOTAL, HORÁRIO (mm)"]
    df["Observed_value"] = df["PRECIPITAÇÃO TOTAL, HORÁRIO (mm)"]
    ...
    df3.to_csv(outname+"_precipitation_342.psv", index=False, sep="|")
