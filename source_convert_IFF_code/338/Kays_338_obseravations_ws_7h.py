...
df['Report_type_code']=''
df["Observed_value"]=df["Vent 7h"]
df['Original_observed_value']=df["Vent 7h"]
df.loc[df['7h.4'] == 'Calme', 'Observed_value'] = 0
df.loc[df['7h.4'] == 'Calme', 'Measurement_code_1'] = "wd1"
df.loc[df['7h.4'] == 'Calme', 'Original_observed_value'] = 0
...
df.to_csv("338-00001_wind_speed_7h.csv", index=False, sep=",")
