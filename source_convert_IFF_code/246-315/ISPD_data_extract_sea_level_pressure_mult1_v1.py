...
for station in stationList:
    ...
    if locs.shape[0] == currentDataFrame["Observed_value"].shape[0]:
        ...
        currentDataFrame.to_csv(os.path.join(os.curdir, "output/sea_level_pressure", station + "_sea_level_pressure_285.psv"),sep="|",index=False)
