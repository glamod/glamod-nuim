c     Subroutine to export observation table for Meteiranne
c     AJ_Kettle, Dec23/2017
c     Jan12/2018: removed original value in case no conversion performed
c     Feb14/2018: to create 50 column observation table

      SUBROUTINE export_observation_day3(f_ndflag,s_directory_root,
     +  l_datalines,
...
c************************************************************************
      print*,'just inside export_observation_day'
c      print*,'f_vec_rain_mm=',(f_vec_rain_mm(i),i=1,10)
c      print*,'f_vec_maxdy_c=',(f_vec_maxdy_c(i),i=1,10)
c      print*,'f_vec_mindy_c=',(f_vec_mindy_c(i),i=1,10)
c      CALL SLEEP(5)
...
c         40.s_original_value
          ...
          IF (k.EQ.3) THEN                       !airt_c
           IF (s_conversion_flag.EQ.'2') THEN
            s_original_value=''
           ENDIF
           IF (s_conversion_flag.NE.'2') THEN 
            f_test=f_vec_mindy_c(j)
            IF (f_test.EQ.f_ndflag) THEN 
             s_original_value='NULL'
            ENDIF
            IF (f_test.NE.f_ndflag) THEN
...
c*******
c************************************************************************
      print*,'just leaving export_observation_day'
