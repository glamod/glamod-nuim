...
OUTDIR = "D:/Palatina/sef_data/daily/ta/IFF"
os.chdir("D:/Palatina/sef_data/daily/ta")
extension = 'tsv'
...
os.chdir("D:/Palatina/sef_data/daily/ta/IFF")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_mean__temperature_357.psv'.format(cat), "w", newline = "")
