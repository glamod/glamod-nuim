...
os.chdir("D:/Indian_stationdata_187578_1884_188990/data_converted/RH")
extension = 'csv'
...
df['Original_observed_value_units']="percentage"
...
with open('output.csv') as fin:    
    ...
    os.chdir("D:/Indian_stationdata_187578_1884_188990/data_converted/RH/IFF")
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_relative_humidity_323.psv'.format(cat), "w", newline = "")
