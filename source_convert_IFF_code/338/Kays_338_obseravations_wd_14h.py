...
df['Measurement_code_1']=df["Direccion 14h "]
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["Direccion 14h "]
df['Original_observed_value']=df["Direccion 14h "]
df.loc[df['Direccion 14h '] == 'Calme', 'Observed_value'] = "Calme"
...
df.to_csv("338-00001_wind_diection_14h.csv", index=False, sep=",")
