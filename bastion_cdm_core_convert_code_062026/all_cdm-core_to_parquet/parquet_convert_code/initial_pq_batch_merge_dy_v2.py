...
# Configuration
# -----------------------------
BASE_TEMP_DIR = "/ichec/work/glamod/land_project_workspace/data/level2/cdm_obs_core/daily_data/r8.2/daily_pq_tmp"
BASE_FINAL_DIR = "/ichec/work/glamod/land_project_workspace/data/level2/cdm_obs_core/daily_data/r8.2/final_merged_pq"
...
for folder in SUBFOLDERS:
    ...
    LOG_FILE = os.path.join(LOG_DIR, f"dy_merge_log_{folder}.txt")
