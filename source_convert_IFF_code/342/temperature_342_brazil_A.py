...
OUTDIR = "D:/brazil_inmet/DataA_all_years_IFF/temperature"
...
for filename in all_filenames:
    ...
    #df3 = pd.read_csv("D:/brazil_inmet/inventory/header.csv",index_col="REGIAO:",squeeze=True)
    df3 = pd.read_csv("D:/brazil_inmet/inventory/header.csv",index_col="REGI?O:",squeeze=True)
    ...
    #df['Hour'] = df['HORA (UTC)']
    df["Original_observed_value"] = df["TEMPERATURA DO AR - BULBO SECO, HORARIA (°C)"]
    df["Observed_value"] = df["TEMPERATURA DO AR - BULBO SECO, HORARIA (°C)"]
    ...
    df3.to_csv(outname+"_temperature_342.psv", index=False, sep="|")
