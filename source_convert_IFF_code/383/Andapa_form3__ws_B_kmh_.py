...
os.chdir("C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_3/Andapa_Form_3/B/")
extension = 'xlsx'
...
for filename in all_filenames:
    ...
    #df=df.drop(columns =["8","9","10","11","12","13"])
        ...
        df['Original_observed_value_units']="KMH" ####need to ocnvert from beuafort scle to m/s
        df['Report_type_code']=''
