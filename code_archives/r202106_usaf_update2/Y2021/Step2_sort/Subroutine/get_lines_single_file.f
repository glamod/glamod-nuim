...
c     AJ_Kettle, 20Feb2020
      ...
      SUBROUTINE get_lines_single_file(
...
c************************************************************************
c      print*,'just entered get_lines_single_file'
...
c       PROCEDURE 2: to archive data line
 ...
 100  CONTINUE
      ...
      print*,'number file switches, jj1=',jj1
      print*,'number of lines, jj2=',jj2
      print*,'i_maxstrlen=',i_maxstrlen

c      print*,'jj1=',jj1
      print*,'s_usaf_index=',(s_usaf_index(i),i=1,jj1)

      print*,'just leaving get_lines_single_file'
