...
OUTDIR = "D:/CCSP_China_India_CMcoll/sef/precipitation/out"
os.chdir("D:/CCSP_China_India_CMcoll/sef/precipitation/")
extension = 'tsv'
...
os.chdir("D:/CCSP_China_India_CMcoll/sef/precipitation/out")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_precipitation_337.psv'.format(cat), "w", newline = "")
