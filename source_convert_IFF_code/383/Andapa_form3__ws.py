...
##extract daily tmin 
    try:
        ...
        df_ws["Observed_value"]=df_ws["Observed_value"]/10
...
##extract daily tmax taken 
    try:
        ...
        df_ws2["Observed_value"]=df_ws2["Observed_value"]/10
    ...
    try:
        ...
        df_ws3["Observed_value"]=df_ws3["Observed_value"]/10
        df_ws3["Observed_value"]=df_ws3["Observed_value"]/0.836
    ...
    #change time zones
       ...
       # merged_ws['Observed_value']= round(merged_ws['Observed_value'])
        merged_ws['Original_observed_value']= round(merged_ws['Original_observed_value'])
