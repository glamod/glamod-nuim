...
OUTDIR = "D:/brazil_inmet/DataA_all_years_IFF/relative_humidity/"
...
for filename in all_filenames:
    ...
    #df['Hour'] = df['HORA (UTC)']
    df["Original_observed_value"] = df["UMIDADE RELATIVA DO AR, HORARIA (%)"]
    df["Observed_value"] = df["UMIDADE RELATIVA DO AR, HORARIA (%)"]
    df = df.astype({"Hour": int})
    df["Hour"]=df["Hour"]/100 ##2019 odd
    ...
    df3.to_csv(outname+"_relative_humidity_342.psv", index=False, sep="|")
