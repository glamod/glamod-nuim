...
import pandas as pd
import csv
OUTDIR4 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_1/Andapa_Form_1/dy_evap"
OUTDIR3 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_1/Andapa_Form_1/hr_evap"
OUTDIR2 = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_1/Andapa_Form_1/dy_precip"
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_1/Andapa_Form_1/hr_precip"
os.chdir("C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_1/Andapa_Form_1/")
extension = 'xlsx'
...
#save output file   
        year=merged_precip.iloc[1]["Year"]
        month=merged_precip.iloc[1]["Month"]
        date=(year+"_"+month)
    ...
    #change time zones
        ...
        merged_precip_dy['Timestamp'] = merged_precip_dy['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
...
#save output file   
        year=merged_precip_dy.iloc[1]["Year"]
        month=merged_precip_dy.iloc[1]["Month"]
        date=(year+"_"+month)
        source_id=merged_precip_dy.iloc[1]["Source_ID"]
        cdm_type=(date+"_precipitation_"+source_id)
    ...
    #change time zones
        ...
        merged_evap['Timestamp'] = merged_evap['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
...
#save output file   
   ...
   ###daily evap extract
    ...
    #change time zones
        ...
        merged_evap_dy['Timestamp'] = merged_evap_dy['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
