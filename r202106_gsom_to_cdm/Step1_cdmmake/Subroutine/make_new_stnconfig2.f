...
c     AJ_Kettle, 17Oct2019
      ...
      SUBROUTINE make_new_stnconfig2(s_directory_output_receipt,
     +  s_stnname_single,
     +  l_varselect,s_code_observation,
     +  l_collect_cnt,l_scoutput_numfield,ilen,
...
c     Archive variables by record number & variable channel number
      CHARACTER(LEN=*)    :: s_arch_date_st_yyyy_mm_dd(20,l_varselect)
      CHARACTER(LEN=*)    :: s_arch_date_en_yyyy_mm_dd(20,l_varselect)
...
c     Variables used in subroutine
      ...
      INTEGER             :: l_vec
      INTEGER             :: l_numvar(20)
      CHARACTER(LEN=3)    :: s_list_code_obs(20,l_varselect)
      CHARACTER(LEN=10)   :: s_list_year_st(20,l_varselect)
      CHARACTER(LEN=10)   :: s_list_year_en(20,l_varselect)
      ...
      CHARACTER(LEN=ilen) :: s_collect_datalines_output(20,50)
...
c************************************************************************
      print*,'just entered make_new_stnconfig2'
...
c     Find indices for variables
     ...
     +   TRIM(s_strloc_observed_variables)) THEN
      ...
      print*,'replacement variable indices',
     +  i_index_start_date,i_index_end_date,i_index_observed_variables
...
c     Export receipt file with new stnconfig lines
      ...
      CALL export_stnconfig_lines20200522(
...
c************************************************************************
c*****
      print*,'just leaving make_new_stnconfig2'
