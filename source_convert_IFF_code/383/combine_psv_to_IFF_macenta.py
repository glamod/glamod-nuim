...
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Macenta_Form_3/Macenta_Form_3/ws/IFF"
os.chdir("C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Macenta_Form_3/Macenta_Form_3/ws")
...
##check before using this line!!!!!!!!!!!!!
#df=df.dropna(subset = ['Observed_value'])
#df= df[df['Observed_value'] != "A"]
...
os.chdir("C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Macenta_Form_3/Macenta_Form_3/ws/IFF")    
cats = sorted(df['Station_ID'].unique())
for cat in cats:
    outfilename = cat +"_wind_speed_383.psv"
    print(outfilename)
