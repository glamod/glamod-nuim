...
os.chdir("D:/UERRA_multiple source_sub_daily/UERRA_sub_daily/UERRA_C3_D1.6_digitiseddata_2017-05-30/UERRA_C3_D1.6_digitiseddata_2017-05-30/out/tt/176")
extension = 'csv'
...
with open('output.csv') as fin:    
    ...
    os.chdir("D:/UERRA_multiple source_sub_daily/UERRA_sub_daily/UERRA_C3_D1.6_digitiseddata_2017-05-30/UERRA_C3_D1.6_digitiseddata_2017-05-30/out/tt/176/IFF")
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_temperature_176.psv'.format(cat), "w", newline = "")
