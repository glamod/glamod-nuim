...
OUTDIR = "C:/Users/snoone/Dropbox/Ed_Hawkins_data/weather-rescue-data/UK-DWRs/IFF/fix_iff/london_fix/ta/out"
os.chdir("C:/Users/snoone/Dropbox/Ed_Hawkins_data/weather-rescue-data/UK-DWRs/IFF/fix_iff/london_fix/ta")
extension = 'tsv'
...
for filename in all_filenames:
    ...
    df1=pd.read_csv(filename,sep='\t', squeeze=True,nrows=11,encoding= 'unicode_escape')
    df2=df1.iloc[:,0:2]
...
os.chdir("C:/Users/snoone/Dropbox/Ed_Hawkins_data/weather-rescue-data/UK-DWRs/IFF/fix_iff/london_fix/ta/out")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_temperature_mean_381.psv'.format(cat), "w", newline = "")
