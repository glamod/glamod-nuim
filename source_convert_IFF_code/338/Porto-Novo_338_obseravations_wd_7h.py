...
df['Measurement_code_1']=df["21h.4"]
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["21h.4"]
df['Original_observed_value']=df["21h.4"]
df.loc[df['21h.4'] == 'Calme', 'Observed_value'] = "Calme"
df.loc[df['21h.4'] == 'Calme', 'Measurement_code_1'] = "wd1"
...
os.chdir("D:/African _stations_late19thC_338/338/WD/3")
df.to_csv("338-00003_wind_diection_21h.csv", index=False, sep=",")
