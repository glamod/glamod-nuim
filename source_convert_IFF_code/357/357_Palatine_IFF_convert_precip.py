...
OUTDIR = "D:/Palatina/sef_data/hourly/rr/IFF"
os.chdir("D:/Palatina/sef_data/hourly/rr")
extension = 'tsv'
...
os.chdir("D:/Palatina/sef_data/hourly/rr/IFF")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_precipitation_357.psv'.format(cat), "w", newline = "")
