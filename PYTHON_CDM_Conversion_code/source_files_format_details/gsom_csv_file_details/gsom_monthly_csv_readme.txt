    ...
    1.3  DOWNLOADING
         ...
         a.  XXY########.csv (GSOM Station Data File Name)
             ...
             Y = Station Network Code (Identifies The Station Numbering System Used)
	             ...
	             E = Identification number used in the ECA&D (European Climate Assessment and Dataset)
                         non-blended dataset
             ...
             element groups/attributes does NOT imply spacing within the GSOM Data Files):
                  ...
                  "DP01" = Number of days with >= 0.01 inch/0.254 millimeter in the month.
                           Note: values originally recorded in inches as 0.01 inch are stored as 0.3 millimeters in GHCN-Daily; technically,
                           this test is for values greater than or equal to 0.3 millimeter.
                  "DP01_ATTRIBUTES" = a,S where:                                                                                              
                                           a = DaysMissing (Numeric value): The number of days (from 1 to 5) missing or flagged is provided   
                                           S = GHCN-Daily Dataset Source Code (see Section 1.3.a.iv for more details)     
                                                               
                  "DP10" = Number of days with >= 0.1 inch/2.54 millimeters in the month.
                           Note: values originally recorded in inches as 0.1 inch are stored as 2.5 millimeters in GHCN-Daily; technically,
                           this test is for values greater than or equal to 2.5 millimeter.
                  ...
                  "DYNT" = Number of days with maximum temperature >= 90 degrees Fahrenheit/32.2 degrees Celsius
                  "DYNT_ATTRIBUTES" = a,S where:                                                                                              
                                           a = DaysMissing (Numeric value): The number of days (from 1 to 5) missing or flagged is provided   
                                           S = GHCN-Daily Dataset Source Code (see Section 1.3.a.iv for more details) 

                  "DYSD" = Number of days with maximum temperature >= 90 degrees Fahrenheit/32.2 degrees Celsius
                  "DYSD_ATTRIBUTES" = a,S where:                                                                                              
                                           a = DaysMissing (Numeric value): The number of days (from 1 to 5) missing or flagged is provided   
                                           S = GHCN-Daily Dataset Source Code (see Section 1.3.a.iv for more details) 

                  "DYSN" = Number of days with maximum temperature >= 90 degrees Fahrenheit/32.2 degrees Celsius
                  "DYSN_ATTRIBUTES" = a,S where:                                                                                              
                                           a = DaysMissing (Numeric value): The number of days (from 1 to 5) missing or flagged is provided   
                                           S = GHCN-Daily Dataset Source Code (see Section 1.3.a.iv for more details) 

                  "DYXP" = Number of days with maximum temperature >= 90 degrees Fahrenheit/32.2 degrees Celsius
                  "DYXP_ATTRIBUTES" = a,S where:                                                                                              
                                           a = DaysMissing (Numeric value): The number of days (from 1 to 5) missing or flagged is provided   
                                           S = GHCN-Daily Dataset Source Code (see Section 1.3.a.iv for more details) 

                  "DYXT" = Number of days with maximum temperature >= 90 degrees Fahrenheit/32.2 degrees Celsius
                  "DYXT_ATTRIBUTES" = a,S where:                                                                                              
                                           a = DaysMissing (Numeric value): The number of days (from 1 to 5) missing or flagged is provided   
                                           S = GHCN-Daily Dataset Source Code (see Section 1.3.a.iv for more details) 
                  ...
                  "DYFG_ATTRIBUTES" = No Attributes are included with DYFG (will be blank)

                  "DYHF" = Number of Days with Heavy Fog (visibility less than 1/4 statute mile)
                  "DYHF_ATTRIBUTES" = No Attributes are included with DYHF (will be blank)

                  "DYTS" = Number of Days with Thunderstorms
                  "DYTS_ATTRIBUTES" = No Attributes are included with DYTS (will be blank)
