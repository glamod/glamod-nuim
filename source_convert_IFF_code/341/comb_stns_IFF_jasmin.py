...
os.chdir("/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341_a")
extension = 'psv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
#combine all files in the list
df1 = pd.concat([pd.read_csv(f,delimiter='|') for f in all_filenames])

os.chdir("/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341_b")
extension = 'psv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]

df2 = pd.concat([pd.read_csv(f,delimiter='|') for f in all_filenames])

os.chdir("/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341_c")
extension = 'psv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
os.chdir("/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341_d")
extension = 'psv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
os.chdir("/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341_e")
extension = 'psv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
os.chdir("/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341_f")
extension = 'psv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
os.chdir(r"/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/dew_point_temperature/341")
