...
c     09Apr2020: modified to used with GHCND daily updates
c     12Apr2020: used for 01May2020 GHCND release
...
c************************************************************************
      print*,'just entered readin_subset'
...
c        WRITE(*,*) 'end of file reached'
       ...
       ELSE
        ...
        IF (ii.GE.l_lines_rgh) THEN 
         print*,'emergency stop; too many lines for storage'
         STOP 'readin_subset'
        ENDIF
...
100   CONTINUE
      ...
      print*,'i_lenmin,i_lenmax=',i_lenmin,i_lenmax

c      print*,'s_stnname=',s_stnname(1)
c************************************************************************
      print*,'just leaving readin_subset'
