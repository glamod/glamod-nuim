...
for currentFile in files:
    with open(currentFile, "r") as theFirstFile:
        for line in theFirstFile:
            ...
            field8 = "NULL"
            field9 = line[47:51]
            field10 = line[135:137]
            field11 = line[138:139]
            field12 = line[135:137]
            field13 = "Mins"
            field14 = "NULL"
            field15 = "350"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/IFF/sunshine_mins/") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_sunshine_mins_350_h.psv"
    print(outfilename)
