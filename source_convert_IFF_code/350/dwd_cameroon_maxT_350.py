...
for currentFile in files:
    with open(currentFile, "r") as theFirstFile:
        for line in theFirstFile:
            ...
            field8 = "NULL"
            field9 = line[57:61]
            field10 = line[132:135]
            field11 = line[136:137]
            field12 = line[132:135]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "350"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/IFF/wind_direction/") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_wind_direction_350.psv"
    print(outfilename)
