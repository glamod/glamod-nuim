...
OUTDIR = "D:/Palatina/sef_data/hourly/wd/IFF"
os.chdir("D:/Palatina/sef_data/hourly/wd")
extension = 'tsv'
...
os.chdir("D:/Palatina/sef_data/hourly/wd/IFF")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_wind_direction_357.psv'.format(cat), "w", newline = "")
