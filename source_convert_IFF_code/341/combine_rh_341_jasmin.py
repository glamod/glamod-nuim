...
os.chdir("/work/scratch-pw/snoone/2011_21/rh")
extension = 'csv'
...
#df_final["Observed_value"]= df_final['Observed_value'].astype(int) 
#df_final["Original_observed_value"]= df_final['Original_observed_value'].astype(int) 
os.chdir(r"/gws/nopw/j04/c3s311a_lot2/data/level1/land/level1a_sub_daily_data/relative_humidity/341_g")
