...
OUTDIR = "D:/Palatina/sef_data/hourly/slp/IFF"
os.chdir("D:/Palatina/sef_data/hourly/slp")
extension = 'tsv'
...
os.chdir("D:/Palatina/sef_data/hourly/slp/IFF")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_station_level_pressure_357.psv'.format(cat), "w", newline = "")
