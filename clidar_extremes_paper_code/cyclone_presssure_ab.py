...
df = pd.read_csv("C:/Users/snoone/Dropbox/All publications/clidar_&_wmo_papers_2025/paper/paper1/data/works_data/ab_slp.csv")
...
plt.title("Ambodifotatra Station Level Pressure 1955-1960")
plt.xlabel("Date")
...
plt.tight_layout()
plt.savefig("C:/Users/snoone/Dropbox/All publications/clidar_&_wmo_papers_2025/paper/paper1/data/works_data/monthly_storm_plots/ab_pressure_main_plot.jpg", dpi=300, format='jpeg')
plt.show()

# --- Monthly plots for storm months ---
output_folder = "C:/Users/snoone/Dropbox/All publications/clidar_&_wmo_papers_2025/paper/paper1/data/works_data/ab_monthly_storm_plots"
...
for month in storm_months:
    ...
    plt.title(f"Ambodifotatra Station Level Pressure in {month_str}")
    plt.xlabel("Datetime")
    plt.ylabel("Pressure (hPa)")
    plt.legend()
    plt.grid(True)
