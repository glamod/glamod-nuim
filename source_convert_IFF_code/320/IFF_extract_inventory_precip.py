...
os.chdir ("/work/scratch-nompiio/snoone/convert_IFF/nuschinaweather/output/precipitation/324")
extension = 'psv'
...
for filename in all_filenames:
    ...
    with open('combined.csv') as fin:    
        ...
        os.chdir ("/work/scratch-nompiio/snoone/convert_IFF/YKFeng_NUS_China_324/nuschinaweather/output/precipitation/inventory")
...
df.to_csv("master_inventory_prec.csv",index=False)