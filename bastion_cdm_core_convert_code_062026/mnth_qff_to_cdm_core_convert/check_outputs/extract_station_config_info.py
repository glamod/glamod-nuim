...
>python extract_station_config_info.py --station ZI000067983 --time M --clobber
>python extract_station_config_info.py --subset  --time M
>python extract_station_config_info.py --run_all --time D
