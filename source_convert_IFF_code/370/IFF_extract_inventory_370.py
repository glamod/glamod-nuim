...
os.chdir("C:/Users/snoone/Dropbox/Hungarian_hourly/hourly/historical/ws/IFF")
...
for filename in all_filenames:
    ...
    df2 = df2[["Source_ID",'Station_ID',"Latitude","Longitude",
             "Elevation","Year","End_Year"]]
    df2.to_csv("combined.csv",index=False,sep = ',',encoding="latin-1")
...
dir_name = "C:/Users/snoone/Dropbox/Hungarian_hourly/hourly/historical/ws/IFF"
...
os.chdir("C:/Users/snoone/Dropbox/Hungarian_hourly/")
df.to_csv("ws_inventory_370.csv",index=False)