...
# Configuration
# -----------------------------
BASE_TEMP_DIR = "/ichec/work/glamod/land_project_workspace/data/level2/cdm_obs_core/monthly_data/r8.2/monthly_pq_tmp"
BASE_FINAL_DIR = "/ichec/work/glamod/land_project_workspace/data/level2/cdm_obs_core/monthly_data/r8.2/final_merged_pq"

SUBFOLDERS = ["A", "B", "C", "D", "E"]

LOG_DIR = "/ichec/work/glamod/land_project_workspace/code/git_code/bastion_cdm_core_convert_code_062026/all_cdm-core_to_parquet/parquet_convert_code"
...
for folder in SUBFOLDERS:
    ...
    LOG_FILE = os.path.join(LOG_DIR, f"mnth_merge_log_{folder}.txt")
