...
df['Report_type_code']=''
df["Observed_value"]=df["9h.5"]
df['Original_observed_value']=df["9h.5"]
df.loc[df['9h.4'] == 'Calme', 'Observed_value'] = 0
df.loc[df['9h.4'] == 'Calme', 'Measurement_code_1'] = "wd1"
df.loc[df['9h.4'] == 'Calme', 'Original_observed_value'] = 0
...
df.to_csv("338-00003_wind_speed_9h.csv", index=False, sep=",")
