...
c     06May2021: used for amalgamation of main-update1-update2

      SUBROUTINE export_stnlist_linecount20210506(s_date_st,s_time_st,
...
c     Place header line here for new file
 ...
 1003 FORMAT(t1,a8,t10,i6)
      ...
      WRITE(2,1004) 'Station Netplat ','Main   ','Update ','Update '
      WRITE(2,1004) '                ','       ','1      ','2      '
      WRITE(2,1004) '+--------------+','+-----+','+-----+','+-----+'
 1004 FORMAT(t1,a16,t18,a7,t26,a7,t34,a7)
...
c     Output data line to old file
     ...
     +  l_vec_lines(2),
     +  l_vec_lines(3)
 1006 FORMAT(t1,a16,t18,i7,t26,i7,t34,i7)
