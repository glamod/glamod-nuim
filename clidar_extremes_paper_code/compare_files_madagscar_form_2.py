...
def read_excel_files(directory, filenames):
    ...
    for filename in filenames:
        ...
        if df is not None:
            ...
            df.columns = ["Day", "min_t", "max_t", "mean_t","dbt_7","wbt_7","diff_7","Hstate_7","dbt_12","wbt_12","diff_12","Hstate_12","dbt_17","wbt_17","diff_17","Hstate_17","cld_7","cld_12","cld_17"][:df.shape[1]]
            ...
            for row in range(df1.shape[0]):
                for col in range(df1.shape[1]):
                    ...
                    if (
                        ...
                        (val2 in ["Traces"] and val1 in ["Trace"])
                    ):
                        continue
...
if __name__ == "__main__":
    directory1 = 'C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/data_for_transcribing_2023/completed_kentucky_data_rescue_2025/completed_forms/file_A/form2'
    directory2 = 'C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/data_for_transcribing_2023/completed_kentucky_data_rescue_2025/completed_forms/file_B/form2'
    output_file = 'C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/data_for_transcribing_2023/completed_kentucky_data_rescue_2025/completed_forms/marolambo_mismatched_form2.txt'
    unmatched_file = 'C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/data_for_transcribing_2023/completed_kentucky_data_rescue_2025/completed_forms/marolambo_unmatched_form2.txt'
