...
df['Report_type_code']=''
df["Observed_value"]=df["18h 54.2"]
df['Original_observed_value']=df["18h 54.2"]
...
os.chdir("D:/African _stations_late19thC_338/338/temperature/4")
df.to_csv("338-00004_temperature_18.54h.csv", index=False, sep=",")
