...
df['Report_type_code']=''
df["Observed_value"]=df["pres_8"]
df['Original_observed_value']=df["pres_8"]
...
df.to_csv("386-00001_station_level_pressure_8h.csv", index=False, sep=",")
...
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["maxtemp_8"]
df['Original_observed_value']=df["maxtemp_8"]
#df.fillna("NULL",inplace=True)
#df = df.fillna()
##df.drop(df.tail(4).index,inplace=True)
df = df.astype({"Year": int})
...
df.to_csv("386-00001_maximum_temperature_8h.csv", index=False, sep=",")
...
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["mintemp_8"]
df['Original_observed_value']=df["mintemp_8"]
#df.fillna("NULL",inplace=True)
#df = df.fillna()
##df.drop(df.tail(4).index,inplace=True)
df = df.astype({"Year": int})
...
df.to_csv("386-00001_minimum_temperature_8h.csv", index=False, sep=",")
