...
OUTDIR = "D:/brazil_inmet/DataDaily_A_all_years_IFF/mean_temperature"
...
for filename in all_filenames:
    ...
    df["Elevation"] = ""
    df["Original_observed_value"] = df["TEMP_MED"]
    df["Observed_value"] = df["TEMP_MED"]
    ...
    df2.to_csv(outname+"_mean_temperature_342.psv", index=False, sep="|")
