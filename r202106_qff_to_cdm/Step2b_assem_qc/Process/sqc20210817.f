...
c     01Mar2021: adapted monthly qc assembler for subdaily

c     01Mar2021: full run 20354 stations; c/c=0.36/66.97min

c     17Aug2021: full run 23539 stations; c/c=1.81/8.13min
...
c*****
      ...
      INTEGER             :: io
c************************************************************************
      print*,'start program sqc20210817'
c************************************************************************
c     Find start time    
...
c     Remove temporary list
      ...
      print*,'l_rgh_stn=',l_rgh_stn
c      STOP 'sqc20210817'
c************************************************************************
c     Routine read in file lines & append them in new file
      CALL get_lines_append_stnconfig20210817(
