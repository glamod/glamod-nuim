...
df['Report_type_code']=''
df["Observed_value"]=df["7h.3"]
df['Original_observed_value']=df["7h.3"]
...
os.chdir("D:/African _stations_late19thC_338/338/RH/1")
df.to_csv("338-00001_relative_humidity_7h.csv", index=False, sep=",")
