...
OUTDIR = "D:/Palatina/sef_data/daily/slp/IFF"
os.chdir("D:/Palatina/sef_data/daily/slp")
extension = 'tsv'
...
os.chdir("D:/Palatina/sef_data/daily/slp/IFF")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_mean__station_level_pressure_357.psv'.format(cat), "w", newline = "")
