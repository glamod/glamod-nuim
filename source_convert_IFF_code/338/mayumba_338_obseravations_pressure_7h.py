...
df['Report_type_code']=''
df["Observed_value"]=df["6h 30.1"]
df['Original_observed_value']=df["6h 30.1"]
...
os.chdir("D:/African _stations_late19thC_338/338/pessure/2")
df.to_csv("338-00002_station_level_pressure_6.30h.csv", index=False, sep=",")
