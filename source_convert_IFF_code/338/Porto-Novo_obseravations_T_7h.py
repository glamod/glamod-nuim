...
df["Source_QC_flag"]=""
df['Original_observed_value_units']="Knots"
df['Measurement_code_1']=''
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["15h.5"]
df['Original_observed_value']=df["15h.5"]
...
os.chdir("D:/African _stations_late19thC_338/338/WS/3")
df.to_csv("338-00003_wind_speed_15h.csv", index=False, sep=",")
