...
df['Report_type_code']=''
df["Observed_value"]=df["pres_18"]
df['Original_observed_value']=df["pres_18"]
...
df.to_csv("386-00001_station_level_pressure_18h.csv", index=False, sep=",")
...
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["maxtemp_18"]
df['Original_observed_value']=df["maxtemp_18"]
#df.fillna("NULL",inplace=True)
#df = df.fillna()
##df.drop(df.tail(4).index,inplace=True)
df = df.astype({"Year": int})
...
df.to_csv("386-00001_maximum_temperature_18h.csv", index=False, sep=",")
...
df['Measurement_code_2']=''
df['Report_type_code']=''
df["Observed_value"]=df["mintemp_18"]
df['Original_observed_value']=df["mintemp_18"]
#df.fillna("NULL",inplace=True)
#df = df.fillna()
##df.drop(df.tail(4).index,inplace=True)
df = df.astype({"Year": int})
...
df.to_csv("386-00001_minimum_temperature_18h.csv", index=False, sep=",")
