...
###needd to calculate decimals offline and input here
            ...
            field11 = line[125:127]
            field12 = line[122:125]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "349"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Labrador data/data_canada/IFF/wind_direction") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_wind_direction_349.psv"
    print(outfilename)
