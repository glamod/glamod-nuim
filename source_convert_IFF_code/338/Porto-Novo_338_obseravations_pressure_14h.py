...
df['Report_type_code']=''
df["Observed_value"]=df["14h.1"]
df['Original_observed_value']=df["14h.1"]
...
os.chdir("D:/African _stations_late19thC_338/338/pessure/3")
df.to_csv("338-00003_station_level_pressure_14h.csv", index=False, sep=",")
