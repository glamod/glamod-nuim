...
#import numpy as np     
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/data_cameroon/test") 
...
###need to calculate decimals offline and input here
            ...
            field8 = "NULL"
            field9 = line[57:61]
            field10 = line[187:191]
            field11 = line[191:193]
            field12 = line[187:191]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "350"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/IFF/precipitation/12h") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_precipitation_350.psv"
    print(outfilename)
