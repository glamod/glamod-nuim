...
for filename in all_filenames:
    ...
    try:
        ...
        dft_out['Original_observed_value_units']="C"
     ...
     ##separate the date to get day and month and  
        ...
        id2 = str(id)
        outname = os.path.join("D:/Russian stations(Barometer-Temperature)/Russian stations(Barometer-Temperature)/IFF/temperature", id2)
        dft_out.to_csv(outname+"_temperature_371.psv", index=False, sep="|")
    except:
        continue
