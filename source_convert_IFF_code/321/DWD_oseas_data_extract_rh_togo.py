...
os.chdir(r"D:/DWD_overseas_subdy/data_togo/output")
...
os.chdir(r"D:/DWD_overseas_subdy/data_togo/output/relative_humidity")
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_relative_humidity_321.psv"
    print(outfilename)
