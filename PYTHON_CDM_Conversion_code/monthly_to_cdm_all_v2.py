...
>python monthly_to_cdm_all_v2.py --station STATIONID
>python monthly_to_cdm_all_v2.py --subset FILENAME
>python monthly_to_cdm_all_v2.py --run_all
>python monthly_to_cdm_all_v2.py --help
...
def main(station="", subset="", run_all=False, clobber=False):
    ...
    for filename in all_filenames:
        ...
        dfobs['original_value'] = pd.to_numeric(dfobs['original_value'], errors='coerce')
                # Round 'original_value' again to ensure it has 1 decimal place
