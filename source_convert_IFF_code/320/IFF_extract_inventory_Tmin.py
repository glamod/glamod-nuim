...
for filename in all_filenames:
    ...
    with open('combined.csv') as fin:    
        ...
        os.chdir ("/work/scratch-nompiio/snoone/convert_IFF/YKFeng_NUS_China_324/nuschinaweather/output/minimum_temperature/inventory")
...
df.to_csv("master_inventory_minT.csv",index=False)