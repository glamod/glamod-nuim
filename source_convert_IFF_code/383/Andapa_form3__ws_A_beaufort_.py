...
import pandas as pd
import csv
OUTDIR = "C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_3/Andapa_Form_3/ws"
os.chdir("C:/Users/snoone/Dropbox/OLD_BELGIAN_AFRICAN_DARE_INVENTORY/Kevin_folder_african_inv/checked_forms_clidar_2022/Andapa_Form_3/Andapa_Form_3/A/")
extension = 'xlsx'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]

# Function to convert Beaufort scale to meters per second
def beaufort_to_mps(beaufort):
    # Conversion formula (approximate values)
    return 0.836 * beaufort
...
for filename in all_filenames:
    ...
    #df=df.drop(columns =["8","9","10","11","12","13"])
        ...
        df['Original_observed_value_units']="B" ####need to ocnvert from beuafort scle to m/s
        df['Report_type_code']=''
...
##extract daily tmin 
    try:
        ...
        # Convert Beaufort scale to meters per second
        df_ws["Observed_value"] = df_ws["Observed_value"].apply(beaufort_to_mps)


        print(df_ws[["Original_observed_value", "Observed_value"]])
...
##extract daily tmax taken 
    try:
        ...
        # Convert Beaufort scale to meters per second
        df_ws2["Observed_value"] = df_ws2["Observed_value"].apply(beaufort_to_mps)
    ...
    try:
        ...
        # Convert Beaufort scale to meters per second
        df_ws3["Observed_value"] = df_ws3["Observed_value"].apply(beaufort_to_mps)
    ...
    #change time zones
        ...
        merged_ws['Timestamp'] = merged_ws['Timestamp'].dt.tz_localize('Etc/GMT-3').dt.tz_convert('GMT')
