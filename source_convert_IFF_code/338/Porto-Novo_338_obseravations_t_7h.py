...
df['Report_type_code']=''
df["Observed_value"]=df["Max."]
df['Original_observed_value']=df["Max."]
...
os.chdir("D:/African _stations_late19thC_338/338/temperature/3")
df.to_csv("338-00003_temp_max.csv", index=False, sep=",")
