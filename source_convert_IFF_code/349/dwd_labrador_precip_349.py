...
###need to calculate decimals offline and input here
            ...
            field8 = "NULL"
            field9 = line[48:51]
            field10 = line[166:172]
            field11 = line[172:173]
            field12 = line[166:172]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "349"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Labrador data/data_canada/IFF/precipitation") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_precipitation_349.psv"
    print(outfilename)
