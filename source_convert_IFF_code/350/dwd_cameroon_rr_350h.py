...
for currentFile in files:
    with open(currentFile, "r") as theFirstFile:
        for line in theFirstFile:
            ...
            field8 = "NULL"
            field9 = line[47:51]
            field10 = line[124:128]
            field11 = line[129:130]
            field12 = line[124:128]
            field13 = "NULL"
            field14 = "NULL"
            field15 = "350"
            field16 = "NULL"
...
os.chdir(r"D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/IFF/precipitation/") 
cats = sorted(giantDataFrame['Station_ID'].unique())
for cat in cats:
    outfilename = cat + "_precipitation_350_h.psv"
    print(outfilename)
...
#giantDataFrame2.to_csv("D:/Other_Sub_Daily_Data_inventory_pending/Cameroon_dwd/errorsh.csv",index=False)