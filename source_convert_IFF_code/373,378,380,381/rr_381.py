...
OUTDIR = "D:/Ed_Hawkins_data/ehawkins/UK-DWRs/IFF/tmax"
os.chdir("D:/Ed_Hawkins_data/ehawkins/UK-DWRs/sef_data/tmax")
extension = 'tsv'
...
os.chdir("D:/Ed_Hawkins_data/ehawkins/UK-DWRs/IFF/tmax")
extension = 'tsv'
all_filenames = [i for i in glob.glob('*.{}'.format(extension))]
...
with open('combined.csv') as fin:    
    ...
    for row in csvin:
        ...
        if cat not in outputs:
            fout = open ('{}_temperature_maximum_381.psv'.format(cat), "w", newline = "")
